...
import { AiFillFacebook, AiOutlineTwitter, AiOutlineInstagram, AiOutlineFileAdd } from 'react-icons/ai';
import { GiEchoRipples, GiSpring } from 'react-icons/gi';
import { useParams } from 'react-router-dom';
import noImg from '../../../noImage';
import { useTreads } from '../../page/Home';
...
const ProfileInfo = () => {
    ...
    return (
        <section className='flex flex-col gap-2'>
            <Card>
                ...
                <CardBody className='flex flex-col gap-1'>
                    <div className='flex items-center gap-2'>
                        <Typography >Pen name:</Typography> <Typography variant='small'>{Info.pen_name}</Typography>
                    </div>
                    <div className='flex flex-col justify-center gap-0.5'>
                        <Typography >catchphrase:</Typography> <Typography variant='small' className='ml-2'>{Info.catchphrase}</Typography>
                    </div>
                    <div className='flex flex-col justify-center gap-0.5'>
                        <Typography >Education:</Typography> <Typography variant='small' className='ml-2'>{Info.education}</Typography>
                    </div>
                    <div className='flex items-center justify-between gap-0.5'>
                        <Typography >Handles</Typography>
                        <div className='flex gap-2'>
                            <IconButton size='sm' ><AiFillFacebook /></IconButton>
                            <IconButton size='sm' ><AiOutlineTwitter /></IconButton>
                            <IconButton size='sm'><AiOutlineInstagram /></IconButton>
                        </div>
                    </div>
            ...
            <Card>
                <CardBody>
                    {/* {!!tread.length && Info?.masterpieces && Info.masterpieces.map((i) => {
